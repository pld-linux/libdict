...
libdict to mała biblioteka w C dająca dostęp do serwerów słowników
zgodnych z RFC2229. Służy do tego szereg funkcji, z których każda
reprezentuje dużą funkcję serwera dict.
